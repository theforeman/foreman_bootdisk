  ...
  def self.load_defaults
    ...
    Setting.transaction do
      [
        ...
        self.set('bootdisk_host_template', N_('iPXE template to use for host-specific boot disks'), 'Boot disk iPXE - host', 'bootdisk_host_template', nil, :collection => templates),
        self.set('bootdisk_generic_host_template', N_('iPXE template to use for generic host boot disks'), 'Boot disk iPXE - generic host', 'bootdisk_generic_host_template', nil, :collection => templates),
